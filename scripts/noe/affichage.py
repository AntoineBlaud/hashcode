...
def write_score(player, computer):
    ...
    pen.pendown()
    pen.color("black")
    pen.write("Score: joueur {} | ordi {}".format(
        player, computer),  font=("Arial", 13, "normal"))
    pen.hideturtle()
...
def display_game(game: dict):
    for boatid in game.keys():
        boat_content = game[boatid]
