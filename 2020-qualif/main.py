...
if __name__ == '__main__':
    ...
    DEFAULT_F = "C:\\Users\\antoi\\Documents\\GitHub\\hashcode\\2020-qualif\\in\\f_libraries_of_the_world.txt"
    OUTPUT_F = "C:\\Users\\antoi\\Documents\\GitHub\\hashcode\\2020-qualif\\out\\f_libraries_of_the_world.txt"
    ...
    def get_Best_librairies(librairies, booksValue, deadline, timeNow):
        librairies_scores = []
    ...
    while(timeNow < deadline-1 and len(librairies) > 0 and timeNow < deadline):
        next_lib, books = get_Best_librairies(librairies, booksValue, deadline, timeNow)
